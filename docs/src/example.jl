...
generate_space_type((prey_b_delta=DeltaPopulation,
        predator_b_delta=DeltaPopulation,
        prey_d_delta=DeltaPopulation,
        predator_d_delta=DeltaPopulation), "JoinedDelta")
...
function natural_causes(initial_pop::Population, delta::JoinedDelta, codomain::Population)
    codomain.predator_population = initial_pop.predator_population + delta.predator_b_delta.delta_pop - delta.predator_d_delta.delta_pop
    codomain.prey_population = initial_pop.prey_population + delta.prey_b_delta.delta_pop - delta.prey_d_delta.delta_pop
end
